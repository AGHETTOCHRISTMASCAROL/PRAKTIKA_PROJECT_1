...
public class filmCinema extends AppCompatActivity {
    TextView tvInfo;
    EditText tvName;
    MyTask mt2;
    ...
    class MyTask extends AsyncTask<String, Void, ArrayList<String[]>> {
        ...
        protected void onPostExecute(ArrayList<String[]> result) {
            ...
            filmCinema.ClAdapter clAdapter=new
                    filmCinema.ClAdapter(tvInfo.getContext(),result);
